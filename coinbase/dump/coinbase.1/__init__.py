...
from coinbase.models import CoinbaseAmount, CoinbaseButton, CoinbaseTransaction, CoinbaseUser
...
class CoinbaseAccount(object):
    ...
    #def create_button(self, from_email, amount, notes='', currency='BTC'):
    #def create_button(self, name, price_string, price_currency_iso, custom, callback_url, description, button_type='buy_now', style='custom_large'):
