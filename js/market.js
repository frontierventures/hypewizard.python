...
function add_ask_to_market(rule, ask) { 
    ...
    $('.asks').append(
            ...
            '<div style="text-align:center"><a href="https://twitter.com/' + ask.twitter_name + '">' + ask.twitter_name + '</div>' +
            '<div style="text-align:center"><a href="https://twitter.com/' + ask.twitter_name + '/status/' + ask.twitter_status_id + '">' + ask.twitter_status_id + '</div>' +
...
function add_bid_to_market(rule, bid) { 
    ...
    $('.bids').append(
            ...
            '<div style="text-align:center"><a href="http://twitter.com/' + bid.twitter_name + '">' + bid.twitter_name + '</div>' +
